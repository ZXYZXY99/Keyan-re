                        ...
                        <el-aside width="10%" style="background-color: #2c3e50" >
                            <el-menu :default-openeds="['1']" router
                                ...
                                <el-submenu index="1" >
                                    ...
                                    <el-menu-item @click="bedroom('/usermanage')">人员管理</el-menu-item>
                                    <el-menu-item @click="bedroom('/laboratory')">实验室管理</el-menu-item>
                                    <el-menu-item @click="bedroom('/labinspect')">实验室申请审核</el-menu-item>
                                    <el-menu-item @click="bedroom('/project')" >科研项目管理</el-menu-item>
                                    <el-menu-item @click="bedroom('/projectsh')" >科研项目审核</el-menu-item>
<!--                                    <el-menu-item @click="bedroom('/bedroom')">寝室管理</el-menu-item>-->
                                    <el-menu-item @click="bedroom('/admincenter')">个人中心</el-menu-item>
        ...
        data() {
            ...
            loginout(){
                ...
                console.log(getToken())
                    this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/admin/out').then(function () {
                        removeToken();
            ...
            const _this=this
            this.axios.get('http://120.26.90.28:8098/cloudzuul/keyanservice/admin/getusername').then(function (resp) {
