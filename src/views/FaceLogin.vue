            ...
            facelogin(){
                ...
                setTimeout(function () {
                    ...
                    _this.imagestring.imagebast64=img
                        ...
                        //     },
                        //     url: 'http://120.26.90.28:8088/cloudzuul/admin/loginface',
                        //     data: params,
                        //     // params:params
                        // })
                        // this.axios.get('https://120.26.90.28:8088/codeservice/codeservice/userinfo/loginface',{params:{
                        //     "imagebast64":img
                        //     }})
                            this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/user/loginface'
