    ...
    export default {
        ...
        data(){
            ...
            handleEdit(index,row){
                ...
                const _this=this;
                this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/laboratory/applayupdate',null,{params:{
                    id:row.id,
            ...
            reget(){
                const _this=this;
                this.axios.get('http://120.26.90.28:8098/cloudzuul/keyanservice/laboratory/getlist').then(function
                    (resp) {
