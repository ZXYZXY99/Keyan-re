    ...
    export default {
        ...
        data(){
            ...
            handleEdit(index){
                const _this=this;
                index.ispass='yes';
                this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/laboratory-applay/admin/updateLab',index)
                    .then(function (resp) {
                    console.log(resp)
            ...
            submitEditForm(reson){
                const _this=this;
                console.log(this.dialogDate)
                this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/laboratory-applay/admin/updateLab',_this.dialogDate)
                    .then(function (resp) {
                        console.log(resp)
                        if (resp.data.code=="10000"){
            ...
            flushTableDate(){
                const _this=this
                this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/laboratory-applay/admin/getapplaying').then(function (resp) {
