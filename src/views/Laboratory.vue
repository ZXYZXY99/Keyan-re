        ...
        data(){
            ...
            submitEditForm(addDate){
                ...
                if (this.addDate.laboratoryNum==''){
                    ...
                    this.axios.post('http://localhost:8098/cloudzuul/keyanservice/laboratory/admin/addLab',_this.addDate)
                        .then(function (resp) {
                            console.log(resp)
            ...
            resetForm(){
                ...
                const _this=this;
                this.axios.get('http://localhost:8098/cloudzuul/keyanservice/laboratory/getAll').then(function
                    (resp) {
            ...
            handleDelete(index,row){
                ...
                this.axios.post('http://localhost:8098/cloudzuul/keyanservice/laboratory/admin/deleteLab',index)
                    .then(function (resp) {
                    console.log(resp)
                        if (resp.data.code=='10000'){
