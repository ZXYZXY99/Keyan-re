    ...
    export default {
        name: "UserCenter",
            data(){
                    ...
                    this.axios.get("http://120.26.90.28:8098/cloudzuul/keyanservice/user/isfaceinfo").then(function
                            (resp) {
                            // console.log(resp)
                            _this.isfaceinfo=resp.data.data
                    })

                    this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/laboratory-applay/getUserLab').then(function (resp) {
                           // console.log(resp)
                    ...
                    this.axios.post('http://120.26.90.28:8098/cloudzuul/keyanservice/project-applay/applayprojectuser').then(function (resp) {
                            console.log(resp)
