...
// Vue.prototype.$Ld=ld;
const  Writerouter=['/login','/register','/loginface']; //indexOf判断是否存在某个对象，如果不存在，则返回-1
const user=['/userlab','/applaymyproject','/myproject','/usercenter']
//路由守卫
